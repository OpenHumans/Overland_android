...
<img src="Screenshots/settingsView.jpg" width="300">
...
* `Activity Type` - [iOS only] Presumably, this affects iOS stop-detect algorithm. Apple is vague about what exactly this option does.[link](https://developer.apple.com/documentation/corelocation/cllocationmanager/1620567-activitytype?preferredLanguage=occ) [Android] - not available ->
